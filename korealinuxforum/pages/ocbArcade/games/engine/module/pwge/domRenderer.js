define("pwge/domRenderer", ["pwge/util", "util/PubSub"], function(util, PubSub){
    ...
    DOMRenderingContext.prototype.reset = function( hardReset ){
        ...
        this.renderingCSSText = "";
         ...
         this.setCSSProperty({key:"webkitTransform", value:"translate3d(-1000px,0,0)"})
    ...
    DOMRenderingContext.prototype.makeReplaceCssText = function( cssText , exp, style) {
        var textArray = cssText.split(';'),
    ...
    DOMRenderingContext.prototype.draw = function( renderingCSSText ){
        ...
        this.refDOMNode.style.cssText = this.makeReplaceCssText( this.refDOMNode.style.cssText, new RegExp('-webkit-transform') , renderingCSSText);
