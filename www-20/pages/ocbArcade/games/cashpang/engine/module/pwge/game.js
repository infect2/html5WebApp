define("pwge/game", ["pwge/runtime", "pwge/config", "pwge/canvas", "pwge/input", "pwge/loader", 'pwge/spriteManager', 'pwge/soundManager', 'pwge/boardManager', 'pwge/renderer', 'pwge/entity', "pwge/util", "util/PubSub", "util/ObjectPool"], function(runtime, config, Canvas, Input, loader, spriteManager, soundManager, BoardManager, Renderer, Entity, util, PubSub, ObjectPool){
    /**
     * game 모듈
     * @exports pwge/game
    ...
    Game.prototype._setDesignResolution = function(w, h, quality) {
        ...
        console.log(this, this.viewport)
